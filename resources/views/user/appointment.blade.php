      ...
      <form class="main-form" action="{{url('appointment')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
            ...
            <option value="">---Select Doctor with Speciality </option>
        ...
        <button type="submit" value="submit" name="submit" class="btn btn-primary mt-3 wow zoomIn">Submit Request</button>
      </form>
    </div>
  </div>